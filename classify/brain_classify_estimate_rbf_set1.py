...
pl.xticks(np.arange(NUMCOLS), GAMMARANGE, rotation = 45)
pl.yticks(np.arange(NUMROWS), CRANGE, rotation = 45)
pl.savefig('hyperparameters_estimate_plots/EBC_RBF_SET1.png')
...
pl.xticks(np.arange(NUMCOLS), GAMMARANGE, rotation = 45)
pl.yticks(np.arange(NUMROWS), CRANGE, rotation = 45)
pl.savefig('hyperparameters_estimate_plots/PPF_RBF_SET1.png')
...
pl.xticks(np.arange(NUMCOLS), GAMMARANGE, rotation = 45)
pl.yticks(np.arange(NUMROWS), CRANGE, rotation = 45)
pl.savefig('hyperparameters_estimate_plots/CONN_RBF_SET1.png')
...
pl.xticks(np.arange(NUMCOLS), GAMMARANGE, rotation = 45)
pl.yticks(np.arange(NUMROWS), CRANGE, rotation = 45)
pl.savefig('hyperparameters_estimate_plots/COMB_RBF_SET1.png')
